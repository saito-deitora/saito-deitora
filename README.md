...
PROF_FILE = "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/origin_images/original/profiles.txt"
...
if __name__ == "__main__":
    ...
    dirname = "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/faces/imface"
    # Tinderからダウンロードした画像を顔検出してトリミングした画像を保存するパス
    save_dirname = "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/faces/save_imface"
    # Tinder APIのトークンを記述
    token = "dddedb89-ac17-4e9e-b039-932c75c243ac"
    # TinderAPIのインスタンス化
    api = tinderAPI(token)
    # 顔検出のためのMTCNNの準備
    mtcnn = MTCNN()
    ...
    # 芸能人の名前とパスの辞書
    favorite_dict = {"川口春奈" : "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/origin_images/croped/3.jpg",
    "新垣結衣" : "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/origin_images/croped/0.jpg",
    "生田絵梨花" : "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/origin_images/croped/1.jpg",
    "齋藤飛鳥" : "C:/Users/81908/Desktop/PythonTutorial/lesson11/autotinder/origin_images/croped/2.jpg"}
            ...
            for person in persons:
                ...
                for i, image_url in  enumerate(person.images):
                    ...
                    if similarity * 100 > 30:
                        ...
                        # 名前、類似度、いいねの表示の順に出力
                        print(person)
                        print('川口春奈どの類似度は',similarity * 100)
                        print('いいねしました')
